                ...
                <div className="card p-4 shadow-lg" style={{ maxWidth: "450px", width: "100%" }}>
                    ...
                    <form onSubmit={postData}>
                        ...
                        <div className="my-3 d-flex justify-content-between">
                            <Link to="/forgetPassword-1" className="text-decoration-none text-primary link-hover">Forgot Password?</Link>
                            <Link to="/signup" className="text-decoration-none text-primary link-hover">Don't have an account? Sign up</Link>
                        </div>
                    </form>
                </div>
            </div>
