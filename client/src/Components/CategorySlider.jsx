    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(200,64,10,0.06) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(244,160,68,0.08) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
                ...
                >
                  <div
                    style={{
                      ...
                      background:
                        "linear-gradient(white, white) padding-box, linear-gradient(135deg, var(--primary), var(--secondary)) border-box",
                      padding: 4,
                      display: "inline-block",
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 16px 40px rgba(200,64,10,0.25)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "";
                      e.currentTarget.style.boxShadow =
                        "0 8px 24px rgba(200,64,10,0.15)";
                    }}
                  >
                    <img
                      src={item.pic}
