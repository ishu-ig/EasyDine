    ...
    return (
        <div id="sidebar" className={isExpanded ? "expanded" : ""}>
            ...
            <ul className="nav flex-column mt-3  sidebar-nav">
                ...
                <li><Link to="/resturent" className="nav-link"><i className="fa fa-store"></i> <span>Resturent</span></Link></li>
                ...
                <li><Link to="/booking" className="nav-link"><i className="fa fa-bell-concierge"></i> <span>Booking</span></Link></li>
